module.exports = (name) =>
    ...
    <title>RECEBEMOS SUA AVALIAÇÃO</title>
    <style>
        :root {
        ...
        <tr>
            <td class='td align-left'>
                <p style="margin-bottom: 0px;">
                    ...
                    <br />  <br />
                    <strong>
                        Agradecemos pela sua avaliação! Sua ajuda foi essencial e valorizamos muito o seu apoio.
                    </strong>
                    <br />  <br />
                    <strong>
                        Grato,
